...
/**
 * @author Nico Tena Enumeración con los posibles scripts que pueden lanzarse a
 * la base de datos
 */
public enum Scripts {
    ...
    MODIFICA_EMPLEADO("modificaempleado.sql"),
    OBTENER_EMPLEADO("obtenerempleado.sql"),
    OBTENER_EMPLEADOS("listaempleados.sql");
